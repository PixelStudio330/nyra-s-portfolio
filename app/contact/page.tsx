...
// Combined entrance + hover animation for stickers
          ...
          <AnimatePresence mode="wait">
            {status !== 'success' ? (
              ...
              >
                ...
                {status === 'error' && (
                  <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center text-xs font-black text-orange-600 uppercase tracking-tighter">
